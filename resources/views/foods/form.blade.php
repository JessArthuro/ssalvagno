        ...
        <form class="row g-3" method="POST" action="{{ $action }}">
            ...
            <div class="col-12 mt-5">
                <div class="d-flex flex-wrap gap-2">
                    <button class="btn btn-primary" type="submit"><i class="las la-{{ $icon }} la-lg"></i> {{ $titleBtn }} Alimento</button>
                    <div class="vr"></div>
                    <a href="{{ route('foods.index') }}" class="btn btn-outline-secondary"><i class="las la-times"></i> Cancelar</a>
                </div>
            </div>
        </form>
    </div>
